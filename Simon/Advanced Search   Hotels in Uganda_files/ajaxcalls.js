...
function start_filtering_ajax_map(newpage) {
    "use strict";
    var action, category, city, area, country, rooms, baths, beds, min_price, price_max, ajaxurl, postid, guest_no, check_out, check_in, all_checkers;
...
function start_filtering_ajax_on_main_map(guest_no) {
    "use strict";
    var action, category, country, city, area, rooms, baths, beds, min_price, price_max, ajaxurl, postid, guest_no, check_out, check_in, all_checkers;
