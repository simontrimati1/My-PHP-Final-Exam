...
var gcCalBG="#d3b880"; // the background color of the outer calendar panel.
var guCalBG=null; // the background image url for the inner table.
var gcCalFrame="#efd4a2"; // the background color of the inner table, showing as a frame.
...
var gcCellBG="#efd4a2"; // default background color of the cells. Use "" for transparent!!!
...
var gcSat="black"; // Saturday font color //"red";
var gcSatBG=null; // Saturday background color
var gcSun="#007f40"; // Sunday font color //"red";
...
var giShowOther=4+8; // control the look of days in OTHER months. 1: show date & agendas effects; 2: show selected & today effects; 4: hide days in previous month; 8: hide days in next month; 16: when set with 4 and/or 8, the days will be visible but notselectable. NOTE: values can be added up to create mixed effects.

var gbFocus=true; // whether to enable the gcToggle highlight whenever mouse pointer focuses over a calendar cell.
var gcToggle="#d3b880"; // the highlight color for the focused cell

var gcFGToday="white"; // the font color for today
var gcBGToday="#007f40"; // the background color for today
...
var gcBGSelected="#d3b880"; // the background color for the selected date
